...
class Multitrous3D(Figure3D):
    ...
    def __init__(self, gamma: np.array = np.array([1, 1])):
        """
        Initializes the Multitrous3D with the given gamma.
    ...
    def function(self, x: np.array) -> np.array:
        """
        Returns the sum of 20 * cos(x^2) and gamma * x^2 along the last axis.
        R^2 -> R
        ...
        Returns:
            np.array: The sum of 20 * cos(x^2) and gamma * x^2 along the last axis.
        """
